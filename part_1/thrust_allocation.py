...
class ThrustAllocator:
    ...
    def allocate(
        ...
        The vehicle has a 3-DOF wrench [Fx, Fy, Mz] and three thrusters, so a
        linear allocation is sufficient for Part 1. For each thruster i,

            [Fx_i, Fy_i, Mz_i]^T = u_i * [cos(alpha_i), sin(alpha_i),
        ...
        # Build the wrench matrix B, where each column is the contribution of one
        # thruster to the 3D wrench [Fx, Fy, Mz]^T.
        ...
        # project checks are primarily about achieving the correct wrench while
        # respecting limits.
